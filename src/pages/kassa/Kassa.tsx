...
const Kassa = memo(() => {
  ...
  const [isStatics, setIsStatics] = useState<string>('')

  const staticsArr = useMemo(
    () => [
      { history: 'storeHistory', content: 'Savdo-sotiq', isActive: false },
      { history: 'oziqOvqatChiqim', content: 'Oziq-ovqat uchun chiqimlar', isActive: false },
      { history: 'korxonaUchunChiqim', content: "Korxona ta'minoti uchun chiqimlar", isActive: false },
    ],
    [],
  )
