...
const Button = memo(({ type = 'button', onClick, content, disbl, customize, width, className, isLoading, statistics = false, isActive, isDownloadble }: any) => {
  return (
    <StyledButton
      // className={
      //   (className ? className : "") +
      ...
      //   (isActive ? " active" : "")
      // }
      className={(className ? className : '') + (customize ? ' customize' : '') + ' btn btn-primary '}
